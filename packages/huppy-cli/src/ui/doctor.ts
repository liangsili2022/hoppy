...
export function getEnvironmentInfo(): Record<string, any> {
    return {
        PWD: process.env.PWD,
        HUPPY_HOME_DIR: process.env.HUPPY_HOME_DIR,
        HUPPY_SERVER_URL: process.env.HUPPY_SERVER_URL,
...
export async function runDoctorCommand(): Promise<void> {
    ...
    console.log(`HUPPY_HOME_DIR: ${env.HUPPY_HOME_DIR ? chalk.green(env.HUPPY_HOME_DIR) : chalk.gray('not set')}`);
    console.log(`HUPPY_SERVER_URL: ${env.HUPPY_SERVER_URL ? chalk.green(env.HUPPY_SERVER_URL) : chalk.gray('not set')}`);
    ...
    console.log(`Documentation: ${chalk.blue('https://huppy.ai/')}`);
