...
import { cleanupDaemonState, isDaemonRunningCurrentlyInstalledHuppyVersion, stopDaemon } from './controlClient';
...
export async function startDaemon(): Promise<void> {
  ...
  const runningDaemonVersionMatches = await isDaemonRunningCurrentlyInstalledHuppyVersion();
  ...
  try {
    ...
    const spawnTrackedHappyProcess = ({
      ...
      const happyProcess = spawnHuppyCLI(args, {
        cwd,
        detached: true,
        stdio: 'ignore',
        env,
