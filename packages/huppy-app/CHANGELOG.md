...
## Version 7 - 2026-03-31

This update gives Huppy a dedicated web marketing homepage so new visitors can understand the product quickly while the native and authenticated app flows stay focused on active sessions.

- Added a new web-only marketing homepage with English and Chinese copy, product storytelling, and live session visuals.
- Improved the home route so unauthenticated web visitors see the marketing site while native users keep the existing welcome flow.
- Connected homepage calls to action to account creation, restore flows, and in-page explainer sections.
...
- Fixed web action buttons to use a Huppy-controlled focus ring instead of the browser's default blue outline.
