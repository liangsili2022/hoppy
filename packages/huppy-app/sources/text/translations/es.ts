...
export const es: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Acerca de',
        aboutFooter: 'Huppy es un cliente móvil para Codex y Claude Code. Todo está cifrado de extremo a extremo y tu cuenta se guarda solo en tu dispositivo. No está afiliado con Anthropic.',
        whatsNew: 'Novedades',
        ...
        supportUs: 'Únete a Huppy Plus',
        supportUsSubtitlePro: 'Todas las funciones desbloqueadas',
        supportUsSubtitle: 'IA ilimitada y sincronización entre dispositivos',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID de sesión de Huppy copiado al portapapeles',
        failedToCopySessionId: 'Falló al copiar ID de sesión de Huppy',
        happySessionId: 'ID de sesión de Huppy',
        ...
        updateCliInstructions: 'Por favor ejecute npm install -g huppy-ai@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instale el Huppy CLI',
            runIt: 'Ejecútelo',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal está solicitando conectarse a tu cuenta de Huppy. Esto permitirá al terminal enviar y recibir mensajes de forma segura.',
    ...
    machine: {
        ...
        offlineHelp: '• Asegúrate de que tu computadora esté en línea\n• Ejecuta `huppy daemon status` para diagnosticar\n• ¿Estás usando la última versión del CLI? Actualiza con `npm install -g huppy-ai@latest`',
    ...
    paywall: {
        headline: 'Deja que la IA trabaje por ti',
        subtitle: 'Únete a miles de usuarios, 3x más productivos',
        reviewText: 'No me daba cuenta del tiempo que perdía. Ahora Huppy hace el trabajo mientras yo me concentro en lo importante.',
        reviewAuthor: 'Marco',
        feature1: 'Conversaciones de IA ilimitadas',
        feature1Sub: 'Claude, GPT-4 y los mejores modelos',
        feature2: 'Mensajes ilimitados, sin límites',
        feature2Sub: 'Chatea en cualquier momento y lugar',
        feature3: 'Sincronización entre dispositivos',
        weeklyLabel: '1 semana',
        yearlyLabel: '1 año',
        freeTrialNote: '7 días de prueba, sin pago ahora',
        noPaymentDue: 'Sin pago ahora',
        cta: 'Comenzar prueba gratuita 🎉',
        restore: 'Restaurar compra',
        loading: 'Cargando...',
        purchaseFailed: 'Error de compra, inténtalo de nuevo',
        terms: 'Términos',
        privacy: 'Privacidad',
    },
