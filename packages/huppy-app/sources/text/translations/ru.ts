...
export const ru: TranslationStructure = {
    ...
    settings: {
        ...
        eula: 'EULA',
        openSourceLicenses: 'Открытые лицензии',
        supportUs: 'Присоединиться к Huppy Plus',
        supportUsSubtitlePro: 'Все функции разблокированы',
        supportUsSubtitle: 'Безлимитный AI и синхронизация',
    ...
    server: {
        ...
        notValidHappyServer: 'Это не валидный сервер Huppy',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID сессии Huppy скопирован в буфер обмена',
        failedToCopySessionId: 'Не удалось скопировать ID сессии Huppy',
        happySessionId: 'ID сессии Huppy',
        ...
        updateCliInstructions: 'Пожалуйста, выполните npm install -g huppy-ai@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Установите Huppy CLI',
            runIt: 'Запустите его',
    ...
    machine: {
        ...
        offlineHelp: '• Убедитесь, что компьютер online\n• Выполните `huppy daemon status` для диагностики\n• Используете последнюю версию CLI? Обновите командой `npm install -g huppy-ai@latest`',
    ...
    paywall: {
        headline: 'Пусть AI работает за вас',
        subtitle: 'Тысячи пользователей повышают продуктивность в 3 раза',
        reviewText: 'Я не понимал, сколько времени трачу впустую. С Huppy работа идёт в разы быстрее.',
        reviewAuthor: 'Марко',
        feature1: 'Безлимитные AI-диалоги',
        feature1Sub: 'Claude, GPT-4 и другие топ-модели',
        feature2: 'Безлимитные сообщения',
        feature2Sub: 'Общайтесь где угодно',
        feature3: 'Синхронизация между устройствами',
        weeklyLabel: '1 неделя',
        yearlyLabel: '1 год',
        freeTrialNote: '7 дней бесплатно, оплата не требуется',
        noPaymentDue: 'Оплата сейчас не требуется',
