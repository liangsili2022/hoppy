...
export const pl: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'O aplikacji',
        aboutFooter: 'Huppy to mobilny klient Codex i Claude Code. Jest w pełni szyfrowany end-to-end, a Twoje konto jest przechowywane tylko na Twoim urządzeniu. Nie jest powiązany z Anthropic.',
        whatsNew: 'Co nowego',
        ...
        supportUs: 'Dołącz do Huppy Plus',
        supportUsSubtitlePro: 'Wszystkie funkcje odblokowane',
        supportUsSubtitle: 'Nielimitowany AI i synchronizacja',
    ...
    server: {
        ...
        notValidHappyServer: 'To nie jest prawidłowy serwer Huppy',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID sesji Huppy skopiowane do schowka',
        failedToCopySessionId: 'Nie udało się skopiować ID sesji Huppy',
        happySessionId: 'ID sesji Huppy',
        ...
        updateCliInstructions: 'Proszę uruchomić npm install -g huppy-ai@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Zainstaluj Huppy CLI',
            runIt: 'Uruchom je',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Terminal żąda połączenia z Twoim kontem Huppy. Pozwoli to terminalowi bezpiecznie wysyłać i odbierać wiadomości.',
    ...
    machine: {
        ...
        offlineHelp: '• Upewnij się, że komputer jest online\n• Uruchom `huppy daemon status`, aby zdiagnozować\n• Czy używasz najnowszej wersji CLI? Zaktualizuj poleceniem `npm install -g huppy-ai@latest`',
    ...
    paywall: {
        headline: 'Niech AI naprawdę pracuje za Ciebie',
        subtitle: 'Dołącz do tysięcy użytkowników, 3x wydajniej',
        reviewText: 'Nie zdawałem sobie sprawy, ile czasu marnuję. Huppy zmienił to całkowicie.',
        reviewAuthor: 'Marco',
        feature1: 'Nielimitowane rozmowy z AI',
        feature1Sub: 'Claude, GPT-4 i inne modele',
        feature2: 'Nielimitowane wiadomości',
        feature2Sub: 'Rozmawiaj kiedy i gdzie chcesz',
        feature3: 'Synchronizacja między urządzeniami',
        weeklyLabel: '1 tydzień',
        yearlyLabel: '1 rok',
        freeTrialNote: '7 dni bezpłatnie, bez opłat teraz',
        noPaymentDue: 'Brak opłat teraz',
        cta: 'Rozpocznij darmowy okres 🎉',
        restore: 'Przywróć zakup',
        loading: 'Ładowanie...',
        purchaseFailed: 'Błąd zakupu, spróbuj ponownie',
        terms: 'Warunki',
        privacy: 'Prywatność',
    },
