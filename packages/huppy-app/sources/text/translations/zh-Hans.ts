...
export const zhHans: TranslationStructure = {
    ...
    server: {
        ...
        notValidHappyServer: '不是有效的 Huppy 服务器',
        changeServer: '更改服务器',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'Huppy 会话 ID 已复制到剪贴板',
        failedToCopySessionId: '复制 Huppy 会话 ID 失败',
        happySessionId: 'Huppy 会话 ID',
        ...
        updateCliInstructions: '请运行 npm install -g huppy-ai@latest',
        deleteSession: '删除会话',
    ...
    settingsVoice: {
        ...
        byoTitle: '使用自己的代理',
        byoDescription: '使用您自己的 ElevenLabs 代理代替 Huppy 默认代理。无需订阅 — 直接使用您自己的 ElevenLabs 账户连接。您的代理必须定义两个客户端工具：messageClaudeCode（向编码代理发送文本）和 processPermissionRequest（允许或拒绝工具使用）。通过 {{initialConversationContext}} 动态变量接收会话上下文。',
        customAgentId: '自定义 ElevenLabs Agent ID',
        customAgentIdNotSet: '当前使用 Huppy 默认代理',
        customAgentIdDescription: '仅在您要使用自己的 ElevenLabs 代理时填写。留空则继续使用 Huppy 默认代理。',
        customAgentIdPlaceholder: 'e.g. abc123def456',
        bypassToken: '直接连接',
        bypassTokenSubtitle: '跳过 Huppy 服务器，直接连接到 ElevenLabs',
    ...
    machine: {
        ...
        offlineHelp: '• 确保您的计算机在线\n• 运行 `huppy daemon status` 进行诊断\n• 您是否在运行最新的 CLI 版本？请使用 `npm install -g huppy-ai@latest` 升级',
        daemon: '守护进程',
        status: '状态',
        stopDaemon: '停止守护进程',
    ...
    paywall: {
        headline: '让 AI 真正为你工作',
        subtitle: '与数千用户一起，效率提升 3 倍',
        reviewText: '以前总觉得 AI 只是玩具，用了 Huppy 才发现可以真正替我干活。现在离不开了。',
        reviewAuthor: '张磊',
        feature1: '无限 AI 对话',
        feature1Sub: '支持 Claude、GPT-4 等顶级模型',
        feature2: '无限消息，不设上限',
        feature2Sub: '随时随地，想说就说',
        feature3: '跨设备无缝同步',
        weeklyLabel: '1 周',
        yearlyLabel: '1 年',
        freeTrialNote: '7 天免费试用，现在无需付款',
        noPaymentDue: '现在无需付款',
        cta: '立即开始免费试用 🎉',
        restore: '恢复购买',
        loading: '加载中...',
