...
export const ja: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'このアプリについて',
        aboutFooter: 'HuppyはCodexとClaude Codeのモバイルクライアントです。完全なエンドツーエンド暗号化を採用し、アカウントはデバイスにのみ保存されます。Anthropicとは提携していません。',
        whatsNew: '新機能',
        ...
        supportUs: 'Huppy Plusに参加',
        supportUsSubtitlePro: 'すべての機能が解放されました',
        supportUsSubtitle: '無制限のAIとデバイス間同期',
    ...
    server: {
        ...
        notValidHappyServer: '有効なHuppy Serverではありません',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'Huppy Session IDがクリップボードにコピーされました',
        failedToCopySessionId: 'Huppy Session IDのコピーに失敗しました',
        ...
        updateCliInstructions: 'npm install -g huppy-ai@latest を実行してください',
    ...
    settingsVoice: {
        ...
        byoDescription: 'Huppy のデフォルトの代わりに、独自の ElevenLabs エージェントを使用します。サブスクリプション不要 — 自分の ElevenLabs アカウントで直接接続できます。エージェントには2つのクライアントツールを定義する必要があります: messageClaudeCode（コーディングエージェントにテキストを送信）と processPermissionRequest（ツール使用を許可または拒否）。セッションコンテキストは {{initialConversationContext}} 動的変数を通じて受信されます。',
        customAgentId: 'ElevenLabs Agent ID',
        customAgentIdNotSet: '未設定',
        customAgentIdDescription: 'ElevenLabs Agent ID を入力してください。空のままにすると Huppy のデフォルトが使用されます。',
        customAgentIdPlaceholder: 'e.g. abc123def456',
        bypassToken: '直接接続',
        bypassTokenSubtitle: 'Huppy サーバーをスキップし、ElevenLabs に直接接続',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'ターミナルがHuppyアカウントへの接続を要求しています。これにより、ターミナルは安全にメッセージを送受信できるようになります。',
    ...
    machine: {
        ...
        offlineHelp: '• コンピューターがオンラインであることを確認してください\n• `huppy daemon status`を実行して診断してください\n• 最新のCLIバージョンを使用していますか？`npm install -g huppy-ai@latest`でアップグレードしてください',
        daemon: 'デーモン',
        status: 'ステータス',
        stopDaemon: 'デーモンを停止',
    ...
    paywall: {
        headline: 'AIに本当に働いてもらおう',
        subtitle: '数千のユーザーと共に、効率3倍アップ',
        reviewText: 'こんなに時間を無駄にしていたとは気づかなかった。Huppyを使い始めてから、仕事が本当に捗るようになった。',
        reviewAuthor: 'マルコ',
        feature1: '無制限のAI会話',
        feature1Sub: 'Claude、GPT-4など主要モデル対応',
        feature2: '無制限メッセージ、上限なし',
        feature2Sub: 'いつでもどこでも',
        feature3: 'デバイス間シームレス同期',
        weeklyLabel: '1週間',
        yearlyLabel: '1年',
        freeTrialNote: '7日間無料トライアル、今すぐ支払い不要',
        noPaymentDue: '今すぐ支払い不要',
        cta: '無料トライアルを開始 🎉',
        restore: '購入を復元',
        loading: '読み込み中...',
