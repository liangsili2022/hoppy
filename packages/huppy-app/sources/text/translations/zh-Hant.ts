...
export const zhHant: TranslationStructure = {
    ...
    settings: {
        ...
        supportUsSubtitlePro: '已解鎖全部功能',
        supportUsSubtitle: '無限對話與跨裝置同步',
    ...
    server: {
        ...
        notValidHappyServer: '不是有效的 Huppy 伺服器',
        changeServer: '更改伺服器',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'Huppy 工作階段 ID 已複製到剪貼簿',
        failedToCopySessionId: '複製 Huppy 工作階段 ID 失敗',
        happySessionId: 'Huppy 工作階段 ID',
        ...
        updateCliInstructions: '請執行 npm install -g huppy-ai@latest',
    ...
    settingsVoice: {
        ...
        byoTitle: '使用自己的代理',
        byoDescription: '使用您自己的 ElevenLabs 代理取代 Huppy 預設代理。無需訂閱 — 直接使用您自己的 ElevenLabs 帳戶連線。您的代理必須定義兩個用戶端工具：messageClaudeCode（向編碼代理傳送文字）和 processPermissionRequest（允許或拒絕工具使用）。透過 {{initialConversationContext}} 動態變數接收工作階段上下文。',
        customAgentId: '自訂 ElevenLabs Agent ID',
        customAgentIdNotSet: '目前使用 Huppy 預設代理',
        customAgentIdDescription: '僅在您要使用自己的 ElevenLabs 代理時填寫。留空則繼續使用 Huppy 預設代理。',
        customAgentIdPlaceholder: 'e.g. abc123def456',
        bypassToken: '直接連線',
        bypassTokenSubtitle: '跳過 Huppy 伺服器，直接連線到 ElevenLabs',
    ...
    machine: {
        ...
        offlineHelp: '• 確保您的電腦在線上\n• 執行 `huppy daemon status` 進行診斷\n• 您是否在執行最新的 CLI 版本？請使用 `npm install -g huppy-ai@latest` 升級',
        daemon: '守護程序',
        status: '狀態',
        stopDaemon: '停止守護程序',
    ...
    paywall: {
        headline: '讓 AI 真正為你工作',
        subtitle: '與數千用戶一起，效率提升 3 倍',
        reviewText: '以前總覺得 AI 只是玩具，用了 Huppy 才發現可以真正替我幹活。現在離不開了。',
        reviewAuthor: '張磊',
        feature1: '無限 AI 對話',
        feature1Sub: '支援 Claude、GPT-4 等頂級模型',
        feature2: '無限訊息，不設上限',
        feature2Sub: '隨時隨地，想說就說',
        feature3: '跨裝置無縫同步',
        weeklyLabel: '1 週',
        yearlyLabel: '1 年',
        freeTrialNote: '7 天免費試用，現在無需付款',
        noPaymentDue: '現在無需付款',
        cta: '立即開始免費試用 🎉',
        restore: '恢復購買',
        loading: '載入中...',
