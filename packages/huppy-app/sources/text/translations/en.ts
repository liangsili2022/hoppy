...
export const en: TranslationStructure = {
    ...
    settings: {
        ...
        supportUs: 'Join Huppy Plus',
        supportUsSubtitlePro: 'All features unlocked',
        supportUsSubtitle: 'Unlimited AI, cross-device sync',
    ...
    server: {
        ...
        notValidHappyServer: 'Not a valid Huppy Server',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'Huppy Session ID copied to clipboard',
        failedToCopySessionId: 'Failed to copy Huppy Session ID',
        happySessionId: 'Huppy Session ID',
        ...
        updateCliInstructions: 'Please run npm install -g huppy-ai@latest',
    ...
    settingsVoice: {
        ...
        byoDescription: 'Use your own ElevenLabs agent instead of the Huppy default. No subscription required — connect directly with your own ElevenLabs account. Your agent must define two client tools: messageClaudeCode (sends text to the coding agent) and processPermissionRequest (allows or denies tool use). It receives session context via the {{initialConversationContext}} dynamic variable.',
        customAgentId: 'Custom ElevenLabs Agent ID',
        customAgentIdNotSet: 'Using Huppy default agent',
        customAgentIdDescription: 'Enter your ElevenLabs agent ID only if you want to use your own agent. Leave empty to keep using the Huppy default.',
        customAgentIdPlaceholder: 'e.g. abc123def456',
        bypassToken: 'Direct Connection',
        bypassTokenSubtitle: 'Skip Huppy server, connect straight to ElevenLabs',
    ...
    machine: {
        ...
        offlineHelp: '• Make sure your computer is online\n• Run `huppy daemon status` to diagnose\n• Are you running the latest CLI version? Upgrade with `npm install -g huppy-ai@latest`',
        daemon: 'Daemon',
        status: 'Status',
    ...
    paywall: {
        headline: 'Let AI Truly Work for You',
        subtitle: 'Join thousands of users, 3x more productive',
        reviewText: "I didn't realize how much time I was wasting. Now Huppy does the work while I focus on what matters.",
        reviewAuthor: 'Marco',
        feature1: 'Unlimited AI conversations',
        feature1Sub: 'Claude, GPT-4 and top models',
        feature2: 'Unlimited messages, no limits',
        feature2Sub: 'Chat anytime, anywhere',
        feature3: 'Cross-device seamless sync',
        weeklyLabel: '1 Week',
        yearlyLabel: '1 Year',
        freeTrialNote: '7 day free trial, no payment now',
