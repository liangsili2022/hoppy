...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        supportUs: 'Junte-se ao Huppy Plus',
        supportUsSubtitlePro: 'Todos os recursos desbloqueados',
        supportUsSubtitle: 'IA ilimitada e sincronização entre dispositivos',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID da sessão Huppy copiado para a área de transferência',
        failedToCopySessionId: 'Falha ao copiar ID da sessão Huppy',
        happySessionId: 'ID da sessão Huppy',
        ...
        updateCliInstructions: 'Por favor execute npm install -g huppy-ai@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instale o Huppy CLI',
            runIt: 'Execute',
    ...
    machine: {
        ...
        offlineHelp: '• Verifique se seu computador está online\n• Execute `huppy daemon status` para diagnosticar\n• Você está usando a versão mais recente do CLI? Atualize com `npm install -g huppy-ai@latest`',
    ...
    paywall: {
        headline: 'Deixe a IA realmente trabalhar por você',
        subtitle: 'Junte-se a milhares de usuários, 3x mais produtivos',
        reviewText: 'Não percebia quanto tempo estava desperdiçando. O Huppy mudou tudo isso.',
        reviewAuthor: 'Marco',
        feature1: 'Conversas de IA ilimitadas',
        feature1Sub: 'Claude, GPT-4 e os melhores modelos',
        feature2: 'Mensagens ilimitadas, sem limites',
        feature2Sub: 'Converse a qualquer hora e lugar',
        feature3: 'Sincronização entre dispositivos',
        weeklyLabel: '1 semana',
        yearlyLabel: '1 ano',
        freeTrialNote: '7 dias de teste, sem pagamento agora',
        noPaymentDue: 'Sem pagamento agora',
