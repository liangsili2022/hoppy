...
export const ca: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Quant a',
        aboutFooter: 'Huppy és un client mòbil de Codex i Claude Code. Tot està xifrat punt a punt i el teu compte es guarda només al teu dispositiu. No està afiliat amb Anthropic.',
        whatsNew: 'Novetats',
        ...
        supportUs: 'Uneix-te a Huppy Plus',
        supportUsSubtitlePro: 'Totes les funcions desbloquejades',
        supportUsSubtitle: 'IA il·limitada i sincronització entre dispositius',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID de la sessió de Huppy copiat al porta-retalls',
        failedToCopySessionId: 'Ha fallat copiar l\'ID de la sessió de Huppy',
        happySessionId: 'ID de la sessió de Huppy',
        ...
        resumeSessionNeedsHappyAgent: 'Resume is unavailable on this machine. Run `huppy-agent auth login` to enable it.',
        ...
        updateCliInstructions: 'Si us plau executeu npm install -g huppy-ai@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instal·la el Huppy CLI',
            runIt: 'Executa\'l',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal està sol·licitant connectar-se al teu compte de Huppy. Això permetrà al terminal enviar i rebre missatges de forma segura.',
    ...
    machine: {
        ...
        offlineHelp: '• Assegura\'t que l\'ordinador estigui en línia\n• Executa `huppy daemon status` per diagnosticar\n• Fas servir l\'última versió del CLI? Actualitza amb `npm install -g huppy-ai@latest`',
    ...
    paywall: {
        headline: 'Deixa que la IA treballi de veritat per tu',
        subtitle: 'Uneix-te a milers d\'usuaris, 3x més productius',
        reviewText: 'No m\'adonava del temps que perdia. Ara Huppy fa la feina mentre jo em centro en el que importa.',
        reviewAuthor: 'Marco',
        feature1: 'Converses d\'IA il·limitades',
        feature1Sub: 'Claude, GPT-4 i els millors models',
        feature2: 'Missatges il·limitats, sense límits',
        feature2Sub: 'Xateja quan i on vulguis',
        feature3: 'Sincronització entre dispositius',
        weeklyLabel: '1 setmana',
        yearlyLabel: '1 any',
        freeTrialNote: '7 dies de prova, sense pagament ara',
        noPaymentDue: 'Sense pagament ara',
        cta: 'Comença la prova gratuïta 🎉',
        restore: 'Restaurar compra',
        loading: 'Carregant...',
        purchaseFailed: 'Error de compra, torna-ho a intentar',
        terms: 'Termes',
        privacy: 'Privadesa',
    },
} as const;
