...
export const it: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Informazioni',
        aboutFooter: 'Huppy è un client mobile per Codex e Claude Code. È completamente cifrato end-to-end e il tuo account è memorizzato solo sul tuo dispositivo. Non affiliato con Anthropic.',
        whatsNew: 'Novità',
        ...
        supportUs: 'Unisciti a Huppy Plus',
        supportUsSubtitlePro: 'Tutte le funzionalità sbloccate',
        supportUsSubtitle: 'AI illimitata e sincronizzazione multi-dispositivo',
    ...
    server: {
        ...
        notValidHappyServer: 'Non è un Huppy Server valido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID sessione Huppy copiato negli appunti',
        failedToCopySessionId: 'Impossibile copiare l\'ID sessione Huppy',
        happySessionId: 'ID sessione Huppy',
        ...
        updateCliInstructions: 'Esegui npm install -g huppy-ai@latest',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Installa la CLI Huppy',
            runIt: 'Avviala',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminale richiede di connettersi al tuo account Huppy. Questo consentirà al terminale di inviare e ricevere messaggi in modo sicuro.',
    ...
    machine: {
        ...
        offlineHelp: '• Assicurati che il tuo computer sia online\n• Esegui `huppy daemon status` per diagnosticare\n• Stai usando l\'ultima versione della CLI? Aggiorna con `npm install -g huppy-ai@latest`',
        daemon: 'Daemon',
        status: 'Stato',
    ...
    paywall: {
        headline: 'Lascia che l\'AI lavori davvero per te',
        subtitle: 'Unisciti a migliaia di utenti, 3x più produttivi',
        reviewText: 'Non mi rendevo conto di quanto tempo stavo sprecando. Huppy ha cambiato tutto.',
        reviewAuthor: 'Marco',
        feature1: 'Conversazioni AI illimitate',
        feature1Sub: 'Claude, GPT-4 e i migliori modelli',
        feature2: 'Messaggi illimitati, senza limiti',
        feature2Sub: 'Chatta ovunque e in qualsiasi momento',
        feature3: 'Sincronizzazione multi-dispositivo',
        weeklyLabel: '1 settimana',
        yearlyLabel: '1 anno',
        freeTrialNote: '7 giorni di prova, nessun pagamento ora',
        noPaymentDue: 'Nessun pagamento ora',
