...
export default function ClaudeOAuth() {
    ...
    return (
        <>
            <OAuthViewUnsupported name="Claude" command="huppy connect claude" />
            {/* <OAuthView
                name="Claude"
                command="huppy connect claude"
...
const OAuthViewUnsupported = React.memo((props: {
    ...
    const command = props.command || `huppy connect ${props.name.toLowerCase()}`;
