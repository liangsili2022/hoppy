...
export default React.memo(() => {
    ...
    const [disconnecting, handleDisconnectGitHub] = useHuppyAction(async () => {
    ...
    const handlePushPermissionRequest = useCallback(async () => {
        ...
        try {
            ...
            if (result.openedSettings) {
                Modal.alert('Open Settings', 'The system will not show the permission prompt again, so Huppy opened Settings instead.');
                return;
            }
