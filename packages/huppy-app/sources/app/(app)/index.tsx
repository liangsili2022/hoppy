...
import { getHomepageMode } from "@/components/web/homepageMode";
import { t } from '@/text';
...
export default function Home() {
    ...
    if (homepageMode === 'marketing') {
        return <MarketingNotAuthenticated />;
    }

    return <WelcomeNotAuthenticated />;
}
...
function useNotAuthenticatedActions() {
    const auth = useAuth();
    ...
    const openRestore = React.useCallback(() => {
...
function MarketingNotAuthenticated() {
    const { createAccount, openRestore } = useNotAuthenticatedActions();
...
function WelcomeNotAuthenticated() {
    const { createAccount, openRestore } = useNotAuthenticatedActions();
